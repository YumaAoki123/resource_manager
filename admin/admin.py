...
import os.path
import sys
from email_service import on_send_button_click, get_all_usernames, get_today_tasks
...
class AdminApp(tk.Tk):
    ...
    def open_admin_dashboard(self):
        ...
        # 認証開始ボタン
        start_auth_button = tk.Button(dashboard_frame, text="認証開始", command=get_today_tasks)
